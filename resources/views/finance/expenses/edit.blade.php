                    ...
                    <form action="{{ route('expenses.update', $expense) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="category_name" class="form-control @error('category_name') is-invalid @enderror" 
                                       value="{{ old('category_name', $expense->category_name) }}" required placeholder="Enter category">
                                @error('category_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="reference_number" class="form-control @error('reference_number') is-invalid @enderror" 
                                   value="{{ old('reference_number', $expense->reference_number) }}" placeholder="Transaction ID, Cheque Number, etc.">
