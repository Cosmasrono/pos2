        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3 border-0">
                    <h5 class="mb-0 fw-bold">Promotion Details</h5>
                </div>
                    ...
                    <form action="{{ route('promotions.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="e.g., Summer Sale 2026" required value="{{ old('name') }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold">Promotion Code</label>
                                <input type="text" name="code" class="form-control" placeholder="SUMMER26" value="{{ old('code') }}">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-bold">Discount Type</label>
                                <select name="type" class="form-select" required>
                                    <option value="fixed" {{ old('type') == 'fixed' ? 'selected' : '' }}>Fixed Amount (KES)</option>
                                    <option value="percentage" {{ old('type') == 'percentage' ? 'selected' : '' }}>Percentage (%)</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Discount Value</label>
                                <input type="number" name="value" class="form-control" step="0.01" min="0" required value="{{ old('value', 0) }}">
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="min_spend" class="form-control" step="0.01" min="0" required value="{{ old('min_spend', 0) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" checked {{ old('is_active') ? 'checked' : '' }}>
                            ...
                            <div class="col-12 mt-4">
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary rounded-pill px-4">Create Promotion</button>
